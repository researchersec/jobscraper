...
URL = "https://www.jobindex.dk/jobsoegning/handel/detailhandel/region-nordjylland"
...
for result in results_sorted:
    ...
    if (
        ...
        # Write to README.md
        with open("salgs/README.md", "w", encoding="utf-8") as file:
            file.write(f"# {title}\n")
...
# Write to JSON file
with open("salgs/data.json", "w") as json_file:
